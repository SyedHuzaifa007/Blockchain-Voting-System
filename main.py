...
def AdminHome():
    ...
    adminFrame.configure(background="white")
    login_btn = Button(adminFrame, text="Login", font=(ARIAL, 13, "bold"),command=AdminLogin, relief=FLAT, border=0, bg="black", fg="white")
    login_btn.place(x=150, y=150, width=150, height=50)
    btn_border = LabelFrame(adminFrame, bd = 0, bg = HIGHLIGHT_BG)
    btn_border.place(x=150, y=250, width=150, height=50)
    reg_btn = Button(btn_border, text="Register", font=(ARIAL, 13, "bold"), command=AdminRegistration, relief=FLAT, border=0, bg="black", fg="white")
    reg_btn.place(x=1, y=1, width=148, height=48)
    back_btn = Button(adminFrame, text="< Back", font=(ARIAL, 10, "normal"), command=Home, border=0, bg="white", fg="grey")
    back_btn.place(x=0, y=0, width=100, height=50)
    label = Label(adminFrame, text="Welcome to \nE-Voting System", font=(ARIAL, 30, "bold"), bg="light grey", fg="black")
    label.place(x=500, y=0, width=400, height=500)
...
def Home():
    ...
    label = Label(homeFrame, text="E-Voting System", font=(ARIAL, 30, "bold"), bg="white", fg="black")
    label.place(x=20, y=100)
    voter_btn = Button(homeFrame, text="Voter ", font=(ARIAL, 13, "normal"), command=VoterHome, relief=FLAT, border=0, bg="grey")
    ...
    admin_btn = Button(btn_border, text="Admin", font=(ARIAL, 13, "normal"), command=AdminHome, relief=FLAT, border=0, bg="light grey")
